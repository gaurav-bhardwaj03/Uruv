...
// for crash recovery
static volatile char ____padding0[PREFETCH_SIZE_BYTES];
...
static volatile char ____padding1[PREFETCH_SIZE_BYTES];
...
static volatile char ____padding2[PREFETCH_SIZE_BYTES];
