...
wangziqi2013::bwtree::BwTree<int64_t, uint64_t>* tree;
...
int main(int argc, char** argv)
{
    ...
    tree = new wangziqi2013::bwtree::BwTree<int64_t , uint64_t, std::less<int64_t>, std::equal_to<int64_t>, std::hash<int64_t>>();
