...
static constexpr size_t MAPPING_TABLE_SIZE = 0x1 << 30;
 ...
 *                   Please refer to Expt1.cpp, class KeyComparator for more
...
class BwTree : public BwTreeBase {
 ...
 public:
   ...
   */
  BwTree(bool start_gc_thread = false,
